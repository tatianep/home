...
export const about = {
  ...
  paragraphs: [
    "My path was never a straight line — it was closer to a superposition. It started with chaos theory and quantum transport in Brazil, moved through computational materials research at the University of Illinois and CEA Grenoble, then detoured into industry AI — pricing models for games played by millions, supply-chain and nutrition ML measured in millions of dollars — before collapsing back onto quantum hardware. That range is the point: I translate fluently between physics, data, and engineering, and I'm at my best where those languages collide.",
